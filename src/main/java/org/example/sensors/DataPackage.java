...
public class DataPackage {
    ...
    public static byte TYPE_CAR = 0;
    public static byte TYPE_2D_CAM = 1;
    public static byte TYPE_3D_CAM = 2;
    public static byte TYPE_DISTANCE_SENSOR = 3;
    public static byte TYPE_LIDAR = 4;
